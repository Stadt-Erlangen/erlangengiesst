...
export const MapLayout: FC<{ treeId?: string | null }> = ({
  ...
  return (
    <>
      <Head>
        <title>Erlangen gießt!</title>
        <meta
          name='viewport'
          content='width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no'
        />
        <link rel='icon' type='image/x-icon' href='/images/favicon.ico' />
        <meta name='title' content='Erlangen gießt' />
        <meta
          name='description'
          content='Die Erlanger Stadtbäume leiden unter Trockenheit und Du kannst ihnen helfen!'
        />
        <meta property='og:url' content='<%= domain %>/' />
        <meta property='og:type' content='website' />
        <meta property='og:title' content='Erlangen gießt!' />
        <meta
        ...
        />
        <meta property='og:site_name' content='Erlangen gießt!' />
